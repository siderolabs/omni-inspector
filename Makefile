...
all: unit-tests-frontend lint-eslint frontend unit-tests omni-inspector image-omni-inspector lint
...
.PHONY: $(ARTIFACTS)/omni-inspector-linux-amd64
$(ARTIFACTS)/omni-inspector-linux-amd64:
	@$(MAKE) local-omni-inspector-linux-amd64 DEST=$(ARTIFACTS)
...
image-omni-inspector:  ## Builds image for omni-inspector.
	@$(MAKE) registry-$@ IMAGE_NAME="omni-inspector"
